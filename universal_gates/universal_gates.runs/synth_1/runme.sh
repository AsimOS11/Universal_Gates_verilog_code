...
HD_PWD='C:/Users/Fazila/Desktop/universal_gates/universal_gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_gates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source universal_gates.tcl
